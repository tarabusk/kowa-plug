...
// Récupérer le code exacte
function kowala_plugin_analytics() {
  /*$analytics = "
...
add_action('init','kowala_plugin_call_ga');
function kowala_plugin_call_ga(){
  if (!is_admin()) {
    if (!current_user_can( 'manage_options' ) ) {
      add_action('wp_footer', 'kowala_plugin_analytics', 35);
    }
  }
}
