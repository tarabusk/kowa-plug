...
?>
<div class="fimg-wrapper fimg-cl fimg-no-meta fimg-no-thumb"><div class="featured-image"><div class="fimg-inner"><div class="vm-wrapper"><div class="vm-middle"><h1 class="post-title">Devenir membre</h1></div></div></div></div></div>
<div id="buddypress">
	...
	<div class="page" id="register-page">
		...
		<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
			...
			<p><?php _e( 'Rejoignez la communauté Kowala afin de poster librement sur notre forum et recevoir nos dernières nouvelles. L\'inscription ne prend que quelques minutes. Remplissez le formulaire sécurisé ci-dessous puis activez votre compte grâce aux liens que vous recevrez par email.', 'buddypress' ); ?></p>
