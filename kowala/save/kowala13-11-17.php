...
/*
function kowala_filter_the_content( $content ) {
		$custom_content = '';
	  if (is_post ()) {
    	$custom_content .=  do_shortcode( '[sommaire]' );
		}
    $custom_content .= 'kk'.$content;
    return $custom_content;
}
add_filter( 'the_content', 'kowala_filter_the_content' );*/
